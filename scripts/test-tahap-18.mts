...
cek('sebab tombol HANYA BACA yang dimatikan', SEBAB_TAK_BISA_BEKU === 'Bagian ini tidak punya data yang bisa diubah, jadi mode hanya baca tidak berpengaruh apa pun.')
