...
e('bba.realisasi', 'Isi realisasi aset', {
  // RAL-7: frasa panjang menang longest-match atas 'isi realisasi' milik kin.realisasi
  k: ['isi realisasi aset', 'realisasi belanja modal', 'realisasi buku besar aset', 'isi realisasi buku besar', 'realisasi bba'],
