...
// Fase F Tahap 14b (K1=C, T12) — `jepitBeku` DIBUANG. Ia menjepit izin EDIT→LIHAT saat
// modul dibekukan, jadi keadaan sementara modul menumpang di jawaban "siapa Anda":
// tombol simpan lenyap, lalu `SpandukLihat` berbunyi "Peran Anda boleh membaca… Hubungi
// pemegang menu ini" — menyalahkan peran dan mengirim orang ke pihak yang tak bisa
// menolong. Pagarnya tidak ikut hilang: `bludMati` dipanggil SEBELUM `bolehEditMenu` di
// tiap handler tulis (`scripts/cek-urutan-penjaga.mjs`, bagian dari gate G), dan
// tombolnya kini mati lewat `KunciTulisProvider` dengan sebab yang benar.
