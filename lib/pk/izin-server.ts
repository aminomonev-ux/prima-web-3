...
// Fase F Tahap 14b (K1=C, T12) — `jepitBeku` DIBUANG, alasan lengkapnya di
// `lib/blud/izin-server.ts`. Urutan "penjaga sakelar sebelum izin menu" di tiap handler
// tulis dijaga `scripts/cek-urutan-penjaga.mjs` (bagian dari gate G).
