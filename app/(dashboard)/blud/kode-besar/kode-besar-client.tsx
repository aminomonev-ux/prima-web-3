    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div className="blud-info-banner" style={{
        ...
        <div style={{ flex: 1, lineHeight: 1.6 }}>
          ...
          Tiap baris jadi kerangka DPA bertingkat: <strong>tingkat 1 (total) → tingkat 2 (kelompok) → tingkat 2.1 (rincian)</strong>.
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <ul className="blud-modal-subtitle text-xs" style={{ paddingLeft: 18, lineHeight: 1.7, margin: 0 }}>
                <li>Kolom <strong>A</strong> = kode kategori. Bentuknya bebas, misal <code>5.X</code> atau <code>5.1.1</code></li>
                <li>Kolom <strong>B</strong> = uraian atau nama kategori</li>
                <li>Baris pertama boleh berisi judul kolom — otomatis dilewati kalau memuat kata <em>Uraian</em>, <em>Nama</em>, atau <em>Akun</em></li>
                <li>Paling banyak 1.000 baris sekali unggah. Berkas: <code>.xlsx</code> · <code>.xls</code> · <code>.csv</code></li>
              </ul>
